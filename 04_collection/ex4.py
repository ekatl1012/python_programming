...
print(days.index(max(hours)))                                                    # ✅ 토요일
...
print(min(scores))
print(max(scores))
result=sorted(scores)                                                    # ✅ max 점수: 92점, min 점수: 76점
print(f"max 점수:{result[-1]}점, min점수 : {result[5]}점")
...
# 총 재고 금액 출력
total=sum(price*num for nam, price, num in stocks)
